  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="menu2.php">TRRAVEL</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <!-- <li class="nav-item active"> -->
              <a class="nav-link <?php if(!isset($_GET['hal'])) echo "active"; ?>" href="menu2.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">See it!</a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="menu2.php?hal=rute2tampil">Data Rute</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="menu2.php?hal=armada2tampil">Data Armada</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="menu2.php?hal=fasilitas2tampil">Data Fasilitas</a>
            </div>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if(isset($_GET['hal']) && $_GET['hal'] == "jadwal2tampil") echo "active"; ?>" href="menu2.php?hal=jadwal2tampil">Jadwal Operasi</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if(isset($_GET['hal']) && $_GET['hal'] == "transaksi2tampil") echo "active"; ?>" href="menu2.php?hal=transaksi2tampil">Transaksi</a>
            </li>
            <!-- <li class="nav-item">
              <a class="nav-link <?php if(isset($_GET['hal']) && $_GET['hal'] == "profil") echo "active"; ?>" href="menu2.php?hal=profil&username=<?php echo $username ?>">Profil</a>
            </li> -->
          </ul>
          <ul class="navbar-nav my-2 my-lg-0">
            <li class="nav-item">
              <a class="nav-link <?php if(isset($_GET['hal']) && $_GET['hal'] == "profil") echo "active"; ?>" href="menu2.php?hal=profil"><?php echo $username ?></a>
            </li>
            <li class="nav-item">
